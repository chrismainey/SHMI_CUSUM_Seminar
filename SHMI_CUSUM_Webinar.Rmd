...
<br>
+ Reporting at site and diagnostics group level is not yet sound due to combination of censoring and overdispersion adjustments.

--

<br>
+ HED is reporting data as provided by NHS Digital, using their methods and site-lookup tables. We regularly are in regular contact with NHSD about SHMI developments and will keep up with any changes.

--

<br>
+ The only noticeable change for users is the ability to select site or diagnostic grouping in the random-effects funnel plot.
...
+ Risk-adjustment in SMRs makes them more complicated
 + i.e. ___don't use an XmR (#plothedots) chart!___
...
- __Aggregated:__  transforms to 'standard score', overdisperison adjustment like SHMI.  CQC method, per month.
...
+ Trigger = 5.48, (0.01% - False Discovery Rate)
+ Reset to zero
...
![](./man/figures/Aggreagate_cusum.gif)
...
+ Trigger unique to each trust and diagnostic group
...
+ Aggreagate trigger remains 5.48 (0.01%FDR)
...
<br>
+ Applied to HSMR, VLAD will be added for SHMI over Christmas period
