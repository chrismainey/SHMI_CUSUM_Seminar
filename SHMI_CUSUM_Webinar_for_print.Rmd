...
```{r setup, echo=FALSE, message=FALSE, warning=FALSE, inlcude=FALSE}
...
+ Trigger value based on normal distribution approximation `r Cite(myBib, "griggEmpiricalApproximationNull2008a", max.names=2)`
...
.pull-right[
```{r ag_csm, fig.align='center', echo=FALSE, fig.retina=2, fig.height=6.5, fig.width=6.5}
...
.pull-right[
```{r prsn_csm, echo=FALSE, fig.align='center', fig.retina=2, fig.height=6.5, fig.width=6.5}
